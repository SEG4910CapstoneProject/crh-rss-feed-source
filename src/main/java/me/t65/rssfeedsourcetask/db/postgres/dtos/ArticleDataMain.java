...
public class ArticleDataMain {
    ...
    private RelatedLinkContentEntity rel_links_content;
    ...
    List<ArticleLabelEntity> article_label_mappings,List<LabelsEntity> labels,ArticleContentEntity article_content,RelatedLinkContentEntity rel_links_content) {
